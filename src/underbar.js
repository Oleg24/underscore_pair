...
(function() {
  ...
  _.filter = function(collection, test) {
      ...
      _.each(collection,function(elem,index,coll){
        if(test(elem,index,coll)){
          results.push(elem);
        }
      })
      return results;
  ...
  _.reject = function(collection, quiz) {
    // TIP: see if you can re-use _.filter() here, without simply
    // copying code in and modifying it
    return _.filter(collection, function (v,i,c){
      return !quiz (v,i,c);
    });
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var accumulator = accumulator !== undefined ? accumulator : _.first(collection);
  ...
  _.every = function(collection, iterator) {
    ...
    return !!_.reduce(collection, function(prev, item){
      ...
      return (iterator || _.identity)(item);
    },true);
  ...
  // This is equivalent to saying: "NOT all the elements FAIL the test"
  _.some = function(collection, iterator) {
    // TIP: There's a very clever way to re-use every() here.
    return !_.every(collection, function(value){
      return !(iterator || _.identity)(value);
    });
  };
